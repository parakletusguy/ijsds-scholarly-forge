...
interface ListResponse { success: true; data: Review[] }
interface SingleResponse { success: true; data: Review }
interface CreateResponse { success: true; data: Review }
...
export const updateReview = async (id: string, updates: Partial<{
  invitation_status: string;
