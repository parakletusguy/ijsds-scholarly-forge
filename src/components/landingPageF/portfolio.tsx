...
const HeadingColumn = styled(Column)<any>(props => [
  tw`w-full xl:w-5/12`,
...
const HeadingDescription = tw.p`text-sm md:text-base lg:text-lg font-medium leading-relaxed text-secondary mt-8`;
...
const CardImage = styled.div<any>(props => [
...
const CardCompany = tw.div`text-primary font-bold text-lg`;
...
export const Portfolio =  ({
  ...
  headingHtmlComponent = (
    <>
      We've done some <span tw="text-primary">amazing projects.</span>
    </>
  ),
