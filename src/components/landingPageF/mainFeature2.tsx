...
const FeatureIconContainer = styled.div`
  ...
  svg {
    ${tw`w-5 h-5 text-primary`}
  }
`;

const FeatureText = tw.div`mt-4 md:mt-0 md:ml-4 text-center md:text-left`;
const FeatureHeading = tw.div`font-bold text-lg text-primary`;
const FeatureDescription = tw.div`mt-1 text-sm`;

const PrimaryButton = tw(PrimaryButtonBase)`mt-8 md:mt-10 text-sm inline-block mx-auto md:mx-0`;

export const MainFeaturetwo = ({
  subheading = "Our Expertise",
  heading = (
    <>
      We have the most professional <span tw="text-[white] font-bold">Peer Reviewing</span> team.
    </>
  ),
  description = "Our distinguished editorial board comprises leading experts in social work and development studies from around the world.",
  ...
  const defaultFeatures = [
    {
      ...
      description: "We have the best professional reviewing team across the Africa just to work with you."
    },
    {
      Icon: DollarSign,
      title: "Affordable",
