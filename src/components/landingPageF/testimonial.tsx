...
// import vgDecoratorBlob2  from "../../images/svg-decorator-blob-5.svg";
...
const TextContainer = styled.div<any>(props => [
...
const Description = tw.p`max-w-md text-center mx-auto lg:mx-0 lg:text-left lg:max-w-none leading-relaxed text-sm sm:text-base lg:text-lg font-medium mt-4 text-secondary`;
...
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-primary`;
const CustomerTitle = tw.p`font-medium text-secondary`;
