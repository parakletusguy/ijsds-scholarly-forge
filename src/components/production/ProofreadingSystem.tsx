...
export const ProofreadingSystem = ({
  article,
  onUpdate,
}: ProofreadingSystemProps) => {
  ...
  const [corrections, setCorrections] = useState([
    {
      ...
      page: 3,
      line: 15,
      error: 'Spelling: "recieve" should be "receive"',
      status: "pending",
      type: "spelling",
    },
    {
      ...
      page: 7,
      line: 22,
      error: "Punctuation: Missing comma after introductory phrase",
      status: "pending",
      type: "punctuation",
    },
    {
      ...
      page: 12,
      line: 8,
      error: "Typography: Inconsistent font in table header",
      status: "corrected",
      type: "formatting",
    },
  ]);
  ...
  const updateCorrectionStatus = (
    correctionId: number,
    newStatus: "pending" | "corrected" | "rejected",
  ) => {
    setCorrections((prev) =>
      prev.map((correction) =>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge
                        className={`text-xs ${getErrorTypeColor(correction.type)}`}
                        variant="secondary"
                      >
                        {correction.type}
                      </Badge>
                  ...
                  {correction.status === "pending" && (
                    <div className="flex gap-2 ml-2">
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          updateCorrectionStatus(correction.id, "corrected")
                        }
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          updateCorrectionStatus(correction.id, "rejected")
                        }
