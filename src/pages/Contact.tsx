  ...
  return (
    <div className="min-h-screen font-body selection:bg-primary-container selection:text-on-primary-container relative">
      <Helmet>
        ...
        <meta
          name="description"
          content="Connect with the IJSDS editorial directorate for high-fidelity inquiries regarding manuscript submissions, technical support, or strategic scholarly collaborations."
        />
      </Helmet>
        ...
        <section className="relative px-8 pt-24 pb-16 max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          <div className="lg:col-span-8">
            <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl text-on-surface leading-[0.9] tracking-tighter mb-8">
              Global Inquiry <br />
              <span className="italic text-primary">Registry</span>
            </h1>
            <p className="max-w-xl font-body text-lg md:text-xl text-on-surface-variant leading-relaxed">
              Connect with the IJSDS editorial directorate for high-fidelity
              inquiries regarding manuscript submissions, technical support, or
              strategic scholarly collaborations.
            </p>
          </div>
          <div className="lg:col-span-4 flex justify-start lg:justify-end">
            <div className="border-l-4 border-primary pl-6 py-2">
              <span className="block text-xs uppercase tracking-[0.2em] font-bold text-primary mb-2">
                Current Status
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-7 bg-surface-container-low p-12 flex flex-col justify-between min-h-[400px] group">
              <div>
                ...
                <p className="font-body text-on-surface-variant max-w-md text-lg">
                  For archival submissions and general scholarly inquiries. The
                  nexus for peer review coordination and manuscript management.
                </p>
                <p className="mt-6 font-mono text-primary select-all cursor-pointer">
              ...
              <div className="mt-12">
                <a
                  ...
                  className="inline-flex items-center gap-3 text-primary font-bold uppercase tracking-widest group-hover:gap-6 transition-all"
                >
                  Direct Link{" "}
            ...
            <div className="md:col-span-5 bg-primary p-12 text-on-primary flex flex-col justify-between min-h-[400px]">
              <div>
                ...
                <h3 className="font-headline text-4xl mb-4 text-on-primary">
                  Digital Line
                </h3>
                <p className="font-body opacity-80 text-lg">
                  Direct access to our editorial directorate (RSU) for real-time
                  institutional coordination.
                </p>
                <p className="mt-6 font-mono text-2xl font-light">
                  +234 808 022 4405
                </p>
              </div>
              <div className="mt-12 bg-white/10 p-6 backdrop-blur-sm">
                <span className="block text-xs uppercase tracking-widest mb-1 opacity-60">
                  Operational Hours
                </span>
            ...
            <div className="md:col-span-4 bg-surface-container-highest p-12 min-h-[350px] flex flex-col justify-between">
              <div>
                ...
                <p className="text-on-surface-variant">
                  Support for registry access and submission bottlenecks.
                </p>
              </div>
            ...
            <div className="md:col-span-8 bg-surface-container text-on-surface p-12 min-h-[350px] relative overflow-hidden flex flex-col justify-between">
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <span className="text-xs font-bold tracking-widest uppercase text-on-surface-variant">
                    Rapid Correspondence Channel
                  </span>
                </div>
                <h3 className="font-headline text-4xl lg:text-5xl mb-6">
                  Registry Chat
                </h3>
                <p className="max-w-md text-on-surface-variant text-lg">
                  Urgent editorial queries handled via our encrypted
                  scholar-to-directorate live link.
                </p>
              </div>
              <div className="relative z-10 flex items-center gap-8">
                ...
                <div className="hidden lg:block">
                  <span className="text-xs text-on-surface-variant font-bold uppercase tracking-widest border-b border-primary/20 pb-1 mr-2">
                    AVG WAIT TIME
                  </span>
                  <span className="block font-headline italic text-on-surface text-xl">
                    Less than 5 minutes
                  </span>
                </div>
              </div>
        ...
        <section className="bg-surface-container-low mt-24 py-32 px-8">
          <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <span className="text-xs uppercase font-bold tracking-[0.4em] text-primary mb-8 block">
                Response Protocol
              </span>
              ...
              <div className="mb-16">
                ...
                <p className="font-headline text-2xl md:text-3xl text-on-surface italic leading-relaxed">
                  "We value scholarly time. Expect professional responses within
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 pt-12">
                <div>
                  <span className="block font-headline text-4xl text-primary mb-2">
                    24h
                  </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-4">
              <h2 className="font-headline text-4xl mb-8">
                Institutional <span className="italic">Residence</span>
              </h2>
              <p className="font-body text-on-surface-variant text-lg mb-12">
                Principal Address — Rivers State University, Nkpolu-Oroworukwo,
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block font-bold text-sm uppercase tracking-widest text-on-surface">
                      Global Reach
                    </span>
                    <span className="text-on-surface-variant">
                      Serving the Pan-African scholarly community and the global
                      research grid.
                    </span>
                  </div>
                </div>
