      ...
      {chief && (
        <ContentSection>
          <div className="relative group overflow-hidden">
            ...
            <div className="hidden sm:block absolute top-0 right-0 w-[400px] h-[400px] bg-primary/5 -z-10 translate-x-20 -translate-y-20 opacity-40" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 0)' }}></div>
